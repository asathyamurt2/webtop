...
<td colspan="3"><dmf:label nlsid="MSG_FACILITY_INSTRUCTIONS"/></td>
	...
	<tr>
	    <td class="fieldlabel" align="right"><b><dmf:label cssclass="defaultDocbaseAttributeStyle" nlsid="MSG_Q_STATE"/>
	    </td>
	    <td class="defaultcolumnspacer">:&nbsp;</td>
	    <td> 
	    <dmf:dropdownlist name="<%= Transmittal.QUERY_STATE_CONTROL %>" >
	    
	    <dmf:option value="2" nlsid="MSG_APPROVED"/>
   	    <dmf:option value="ALL" nlsid="MSG_ALL"/>
	...
	<tr>
	    <td class="fieldlabel" align="right"><b><dmf:label cssclass="defaultDocbaseAttributeStyle" nlsid="MSG_Q_VERSION"/>
	    </td>
	    <td class="defaultcolumnspacer">:&nbsp;</td>
	    <td> 
	    <dmf:dropdownlist name="<%= Transmittal.QUERY_VERSION_CONTROL %>" >
	  	<dmf:option value="ALL" nlsid="MSG_ALL"/>
   	    <dmf:option value="CURRENT" nlsid="MSG_CURRENT"/>
	    </dmf:dropdownlist>
	    </td>
	</tr>
