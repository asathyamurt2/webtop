...
<dmf:webform/>
<dmf:macclientdetect/>
<dmf:title><dmf:label name='windowtitle'/></dmf:title>
<script>
...
<dmf:button name='<%=PropertySheetWizardContainer.NEXT_BUTTON_CONTROL_NAME%>' default="true" cssclass='buttonLink' nlsid='MSG_NEXT' onclick='onNextComponent'
